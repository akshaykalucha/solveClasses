            ...
            return (
                ...
                <div className="container">
                    ...
                    {!this.state.isRegistered ?
                        <form className="mobileform1" onSubmit={this.submitRegistrationFOrm}>
                            <input type="text" onChange={this.handleChange} name="name" value={this.state.name} placeholder="Enter Name..." style={inputStyle}></input>
                            <input type="email" onChange={this.handleChange} name="email" value={this.state.email} placeholder="Enter Email..." style={inputStyle}></input><br/>
                            <input type="text" onChange={this.handleChange} name="type" value={this.state.type} placeholder="Enter Type..." style={inputStyle}></input>
